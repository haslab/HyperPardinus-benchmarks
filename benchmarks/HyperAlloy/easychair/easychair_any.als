...
fun filter[t:Article] : set Article { Article }
...
check NonInterference for exactly 2 Reviewer, exactly 2 Article, 4 steps, 0 Int expect 1
check NonInterference for exactly 3 Reviewer, exactly 2 Article, 6 steps, 0 Int expect 1
...
check GeneralizedNonInterference for exactly 2 Reviewer, exactly 2 Article, 4 steps, 0 Int expect 1
check GeneralizedNonInterference for exactly 3 Reviewer, exactly 2 Article, 5 steps, 0 Int expect 1
