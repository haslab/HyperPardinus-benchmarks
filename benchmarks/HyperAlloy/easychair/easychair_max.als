...
fun select[ds: set Decision] : set Decision { max[ds] }
...
check NonInterference for exactly 2 Reviewer, exactly 2 Article, 10 steps, 0 Int expect 0 
check NonInterference for exactly 3 Reviewer, exactly 2 Article, 10 steps, 0 Int expect 0 
